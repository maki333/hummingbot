...
```
wget https://raw.githubusercontent.com/maki333/hummingbot/development/installation/docker-commands/create.sh
chmod a+x create.sh
./create.sh
```
...
```
wget https://raw.githubusercontent.com/maki333/hummingbot/development/installation/install-docker/install-docker-ubuntu.sh
wget https://raw.githubusercontent.com/maki333/hummingbot/development/installation/docker-commands/create.sh
chmod a+x *.sh
...
##### 1. Download Install Scripts and Install Docker
```
wget https://raw.githubusercontent.com/maki333/hummingbot/development/installation/install-docker/install-docker-debian.sh
wget https://raw.githubusercontent.com/maki333/hummingbot/development/installation/docker-commands/create.sh
chmod a+x *.sh
...
##### 1. Download Install Scripts and Install Docker
```
wget https://raw.githubusercontent.com/maki333/hummingbot/development/installation/install-docker/install-docker-centos.sh
wget https://raw.githubusercontent.com/maki333/hummingbot/development/installation/docker-commands/create.sh
chmod a+x *.sh
